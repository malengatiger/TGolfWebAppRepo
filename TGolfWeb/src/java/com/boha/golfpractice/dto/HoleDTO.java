...
public class HoleDTO implements Serializable {
    ...
    public HoleDTO(Hole a) {
        this.holeID = a.getHoleID();
        holeNumber = a.getHoleNumber();
        lengthFromBlack = a.getLengthFromBlack();
        lengthFromBlue = a.getLengthFromBlue();
        lengthFromRed = a.getLengthFromRed();
        lengthFromWhite = a.getLengthFromWhite();
        par = a.getPar();
